...
function run() {
    ...
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            const defaultRef = (_a = core.getInput('default-ref')) !== null && _a !== void 0 ? _a : process.env.GITHUB_REF_NAME;
            const fluxServerRef = (_b = core.getInput('flux-server-ref')) !== null && _b !== void 0 ? _b : defaultRef;
            const fluxHybridRef = (_c = core.getInput('flux-hybrid-ref')) !== null && _c !== void 0 ? _c : defaultRef;
            const fluxWebRef = (_d = core.getInput('flux-web-ref')) !== null && _d !== void 0 ? _d : defaultRef;
            const fluxStreamingServerRef = (_e = core.getInput('flux-streaming-server-ref')) !== null && _e !== void 0 ? _e : defaultRef;
            let versionString;
